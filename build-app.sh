...
cp "Ghost.icns" "$APP_DIR/Contents/Resources/Ghost.icns"
...
/usr/bin/plutil -replace CFBundleIconFile -string "Ghost" "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -replace CFBundlePackageType -string "APPL" "$APP_DIR/Contents/Info.plist"
/usr/bin/plutil -replace CFBundleSignature -string "????" "$APP_DIR/Contents/Info.plist"
...
/usr/bin/touch "$INSTALL_DIR/$APP_NAME.app"
